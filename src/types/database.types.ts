...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      guide_client_connections: {
        Row: {
          accepted_at: string | null
          client_birth_city: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "guide_client_connections_client_user_id_fkey"
          ...
          {
            foreignKeyName: "guide_client_connections_guide_id_fkey"
            columns: ["guide_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      guide_readings: {
        ...
        Relationships: [
          {
            foreignKeyName: "guide_readings_client_connection_id_fkey"
            columns: ["client_connection_id"]
            isOneToOne: false
            referencedRelation: "guide_client_connections"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "guide_readings_guide_id_fkey"
            columns: ["guide_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      libra_profiles: {
        Row: {
          ...
          secondary_modifier:
            | Database["public"]["Enums"]["archetype_modifier"]
            | null
          updated_at: string
          user_id: string
        }
        Insert: {
          aesthetic_style?:
            | Database["public"]["Enums"]["aesthetic_style"]
            | null
          ai_memory_summary?: string | null
          beauty_affinity?: string | null
          conflict_style?: string | null
      ...
      user_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_alerts_sent_by_fkey"
            columns: ["sent_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
