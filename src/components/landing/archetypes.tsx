      ...
      <div className="container max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="font-serif text-display-md text-foreground mb-4">
            10 Libra archetypes. <span className="text-gold-gradient italic">One is yours.</span>
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Our onboarding quiz profiles your Libra psychology across 12 categories and assigns your
            archetype. Not just a name — a mirror.
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {data.traits.slice(0, 3).map((trait) => (
                    <span
                      key={trait}
                      className="text-xs px-2 py-0.5 rounded-full border border-white/[0.08] text-muted-foreground"
                    >
                      {trait}
                    </span>
                  ))}
        ...
        >
          <p className="text-sm text-muted-foreground mb-5">
            + 4 more archetypes and 8 secondary modifiers
          </p>
          <Link
            href="/signup"
